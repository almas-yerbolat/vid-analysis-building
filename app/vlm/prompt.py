...
3. Спецтехника и краны: наличие и подсчёт по типам. Значение equipment[].type должно \
быть РОВНО одним из следующих токенов, без изменений и без множественного числа: \
башенный_кран, автокран, экскаватор, самосвал, автобетононасос, погрузчик, бульдозер, \
каток, автовышка, бетономешалка. Любая другая техника — прочее. Не придумывай \
собственные названия типов: иначе одна и та же техника разойдётся по разным строкам \
инвентаря.
